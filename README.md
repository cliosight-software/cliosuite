# cliosuite
This repo is for the open-sourced code of the cliosuite applications. This project is partly open-source. 
Our aim is to develop boilerplate projects in various technologies for some of the most relevant areas across industries 
...
The domain related articles that are shared regularly through the cliosight.com blog section. The Cliosuite MSME web application 
